# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-10-30 15:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', phonenumber_field.modelfields.PhoneNumberField(help_text="Avec l'indicatif du pays.", max_length=128, verbose_name='Numéro de téléphone')),
        ...
        migrations.AddField(
            model_name='order',
            name='item',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.VideoGame'),
        ),
    ]
