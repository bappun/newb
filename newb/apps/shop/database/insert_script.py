...
videogames = [
    ['Fifa 18', '29/09/17', [Genre.get(name='Sport')], [Platform.get(name='Windows'), Platform.get(name='Xbox One'), Platform.get(name='PS4'), Platform.get(name='Switch')], [Editor.get(name='EA Sports')], [Developer.get(name='EA Sports')], 'static/img/shop/fifa18.jpeg', 'FIFA 18 est un jeu de simulation de football sur PC, PS4 et Xbox One édité par Electronic Arts. Le mode aventure promet d\'être retravaillé en profondeur, tout en faisant suite à celui du précédent opus. Le championnat chinois fera également son apparition pour la première fois, sans oublier les traditionnelles améliorations apportées aux graphismes et au gameplay, ainsi que le retour de Pierre Ménès et Hervé Mathoux aux commentaires.', '50,99'],
    ['Destiny 2', '06/09/17', [Genre.get(name='Tir')], [Platform.get(name='Windows'), Platform.get(name='Xbox One'), Platform.get(name='PS4')], [Editor.get(name='Activision')], [Developer.get(name='Bungie')], 'http://image.jeuxvideo.com/medias-sm/150607/1506071350-4107-jaquette-avant.jpg', 'Suite du premier opus du même nom réalisé par les créateurs de Halo, Destiny 2 est un FPS futuriste et intergalactique. Les joueurs peuvent y importer les personnages qu\'ils ont créés et améliorés dans le premier opus.', '44,99'],
    ['Super Mario Odyssey', '27/10/17', [Genre.get(name='Plate-forme')], [Platform.get(name='Switch')], [Editor.get(name='Nintendo')], [Developer.get(name='Nintendo')], 'http://image.jeuxvideo.com/medias-sm/150166/1501664378-9988-jaquette-avant.jpg', 'La princesse Peach a été enlevée par Bowser. Pour la sauver, Mario quitte le royaume Champignon à bord de l\'Odyssey. Accompagné de Clappy, son chapeau vivant, il parcourra différents royaumes et fera tout pour vaincre, une nouvelle fois, terrible Bowser.', '44,90']
]
