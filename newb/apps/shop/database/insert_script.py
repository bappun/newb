...
if __name__ == '__main__':
    ...
    videogames = [
        ...
        ['Forza Motorsport 7', '2017-10-03', [Genre.objects.get(name='Course'), Genre.objects.get(name='Simulation')],
         [Platform.objects.get(name='Xbox One'), Platform.objects.get(name='Windows')],
         Editor.objects.get(name='Microsoft'), Developer.objects.get(name='Turn 10'),
         '/media/uploaded/img/shop/forza_motorsport_7.jpg',
         'Forza Motorsport 7 est un jeu de course automobile développé par Turn 10. Septième opus de la série, il bénéficie d\'un mode carrière revu en profondeur et de nouveautés comme le système de météo dynamique.',
         54.99],
        ['PlayerUnknown\'s Battlegrounds', '2017-03-23',
         [Genre.objects.get(name='MMO'), Genre.objects.get(name='Action'), Genre.objects.get(name='Aventure'),
          Genre.objects.get(name='Tir')], [Platform.objects.get(name='Windows')],
         Editor.objects.get(name='Bluehole, Inc.'), Developer.objects.get(name='Bluehole, Inc.'),
         '/media/uploaded/img/shop/playerunknowns_battlegrounds.png',
         'PlayerUnknown\'s Battlegrounds est un jeu multijoueur de type Battle Royale. En partant de rien, il vous faut trouver des armes et des ressources afin d\'être le dernier survivant. Développé avec Unreal Engine 4, vous vous retrouvez sur une île de 8x8 km, avec pour but ultime de ne pas vous faire tuer.',
         23.99]
    ]
